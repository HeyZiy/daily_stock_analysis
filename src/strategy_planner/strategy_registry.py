...
DEFAULT_STRATEGIES = [
    ...
    },
    {
        ...
        "existing_implementation": "etf_allocation.py + src/etf/allocation_gate.py",
        "source": "builtin",
        "created_at": "2026-08-08",
        "added_by": "system",
    },
    {
        ...
        "name": "行业轮动",
        "category": "动量策略",
        "description": "按20日+5日收益率打分，选择动量最强的行业ETF轮动",
        "suitable_regimes": ["trending_up", "weak_up"],
        "existing_implementation": "src/etf/sector_rotation.py",
        "source": "builtin",
        "created_at": "2026-08-08",
        "added_by": "system",
    },
    {
        ...
        "existing_implementation": "ETF配置中包含红利ETF",
        "source": "builtin",
        "created_at": "2026-08-08",
        "added_by": "system",
    },
    {
        ...
        "name": "现金管理（逆回购/货基）",
        "category": "防御策略",
        "description": "空仓等待，资金配置逆回购或货币基金获取无风险收益",
        "suitable_regimes": ["chaos"],
        "existing_implementation": "ETF配置中的现金仓位",
        "source": "builtin",
        "created_at": "2026-08-08",
        "added_by": "system",
    },
    ...
    },
    {
        ...
        "existing_implementation": "ETF配置中包含黄金ETF(159934)",
        "source": "builtin",
        "created_at": "2026-08-08",
        "added_by": "system",
    },
