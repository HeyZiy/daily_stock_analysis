...
DEFAULT_STRATEGIES = [
    ...
    },
    {
        ...
        "category": "动量策略",
        "description": "卫星仓战术策略：在行业ETF清单中捕捉放量突破首日（60日新高/平台突破+涨幅3%-9.5%，量≥5日均量×2且≥20日均量×1.5，行业PE分位<90%），评分≥70买入，10%预算最多2只等权。退出：-7%止损、+15%减半/+25%清仓、3日破MA5、10日不新高、行业PE≥90%（逐只判定）或硬拦截全清。",
        "suitable_regimes": ["trending_up", "weak_up"],
