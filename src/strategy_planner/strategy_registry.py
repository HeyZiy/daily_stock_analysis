...
DEFAULT_STRATEGIES = [
    ...
    },
    {
        ...
        "name": "行业动量轮动（卫星仓）",
        "category": "动量策略",
        "description": "卫星仓战术策略（动量程序行业袖子）：周频截面动量排名选行业（相对沪深300的20/60日超额+量比，前3进关注池），池内ETF放量突破才建仓，10%预算最多2只。退出：动量证伪（相对强度转负/连续2次跌出前5/破MA20缩量/灾难止损-12%）、行业PE≥90%锁仓、市值拥挤度≥95%熔断；硬拦截只禁新开仓不清仓（降杠杆门控）。",
        "suitable_regimes": ["trending_up", "weak_up"],
        "existing_implementation": "src/etf/industry_momentum.py + etf_observe.py 统一执行批次",
        "source": "user_suggested",
        "created_at": "2026-08-15",
        "added_by": "user",
        "doc_ref": "strategy/industry_momentum.md",
    },
    {
