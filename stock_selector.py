...
使用方式：
    python stock_selector.py                    # 使用配置文件的选股条件
    python stock_selector.py "今日涨幅2%的股票"  # 指定选股条件
    python stock_selector.py --list             # 列出当前自选股
    python stock_selector.py --add-to-self      # 选股并添加到自选股
"""
...
def main() -> int:
    ...
    if not keyword:
        ...
        logger.error("示例: python stock_selector.py \"今日涨幅2%的股票\"")
        return 1
